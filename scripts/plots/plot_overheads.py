...
ax1.plot(labels_list, latencies['50'],
         ...
         marker=markers[0], linestyle=styles[0], linewidth=2, markersize=10)
ax1.plot(labels_list, latencies['99'],
         label='99 \%ile', color=colors[1],
         marker=markers[1], linestyle=styles[1], linewidth=2, markersize=10)
...
fig.tight_layout()
plt.subplots_adjust(left=0.08, right=0.98, top=1, bottom=0.2)
