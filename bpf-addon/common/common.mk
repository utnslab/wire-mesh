...
CFLAGS ?= -g -I$(LIBBPF_DIR)/root/usr/include/ $(DEFINES)\
			-I../headers/ -I/usr/include/x86_64-linux-gnu/
LDFLAGS ?= -L$(LIBBPF_DIR)

BPF_CFLAGS ?= -I$(LIBBPF_DIR)/root/usr/include/ -I../headers/ \
			  -I/usr/include/x86_64-linux-gnu/

LIBS = $(USER_LIBS) -l:libbpf.a -lelf -lz
